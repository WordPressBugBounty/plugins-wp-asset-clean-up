        ...
        <tr valign="top" class="wpacu-fonts-legacy-table-row wpacu-local-fonts-legacy-table-row">
            ...
            <td>
                ...
                $fontPreloadScanner = array(
                    ...
                    'enabled_id'           => 'wpacu_local_fonts_preload_files_enable',
                    'enabled_name'         => WPACU_PLUGIN_ID . '_settings[local_fonts_preload_files_enable]',
                    'enabled_value'        => ! empty($data['local_fonts_preload_files_enable']) ? 1 : 0,
                    'enabled_label'        => __('Enable manual local font-file preloading', 'wp-asset-clean-up'),
